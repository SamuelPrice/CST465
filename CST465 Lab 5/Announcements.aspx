...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:SqlDataSource ID="Data" ConnectionString="<%$ ConnectionStrings:DB %>" SelectCommandType ="Text" SelectCommand="SELECT AnnouncementId, Title FROM Announcements" runat="server" />
